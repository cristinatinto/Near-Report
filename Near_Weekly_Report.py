...
with st.expander("Check hourly activity"):
    st.altair_chart(alt.Chart(df)
        ...
        .properties(width=800,title='Hourly active users'))
    
    st.altair_chart(alt.Chart(df)
        .mark_line()
        .encode(x='date:N', y='new_users:Q')
        .properties(width=800,title='Hourly new users'))

with st.expander("Check daily activity"):
    st.altair_chart(alt.Chart(df2)
        .mark_line()
        .encode(x='date:N', y='active_users:Q')
        .properties(width=800,title='Daily active users'))
    
    st.altair_chart(alt.Chart(df2)
        .mark_line()
        .encode(x='date:N', y='new_users:Q')
        .properties(width=800,title='Daily new users'))
...
with st.expander("Check hourly activity"):
    st.altair_chart(alt.Chart(df)
        ...
        .properties(width=800,title='Hourly active contracts'))
    
    st.altair_chart(alt.Chart(df3)
        .mark_line()
        .encode(x='date:N', y='new_contracts:Q')
        .properties(width=800,title='Hourly new contracts'))

with st.expander("Check daily activity"):
    st.altair_chart(alt.Chart(df2)
        .mark_line()
        .encode(x='date:N', y='active_contracts:Q')
        .properties(width=800,title='Daily active contracts'))
    
    st.altair_chart(alt.Chart(df4)
        .mark_line()
        .encode(x='date:N', y='new_contracts:Q')
        .properties(width=800,title='Daily new contracts'))    
...
with st.expander("Check hourly activity"):
    st.altair_chart(alt.Chart(df)
        ...
        .properties(width=800,title='Hourly active validators'))
    
    st.altair_chart(alt.Chart(df)
        .mark_line()
        .encode(x='date:N', y='total_near_staked:Q')
        .properties(width=800,title='Hourly total NEAR staked'))

with st.expander("Check daily activity"):
    st.altair_chart(alt.Chart(df2)
        .mark_line()
        .encode(x='date:N', y='n_validators:Q')
        .properties(width=800,title='Daily active validators'))
    
    st.altair_chart(alt.Chart(df2)
        .mark_line()
        .encode(x='date:N', y='total_near_staked:Q')
        .properties(width=800,title='Daily total NEAR staked'))
